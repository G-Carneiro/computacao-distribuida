...
"config\_node\_test.txt" localizada na pasta "Config" e executar
no terminal o comando: "python3 main.py".
...
Se utilizarmo a seguinte linha "0 : token : 3", iremos observar o token indo do nodo 0
até o nodo 3. Note que não podemos adicionar a nomenclatura broadcast -1 no ID de destino.
