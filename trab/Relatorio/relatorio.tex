...
Foi utilizado o domínio AF\_INET para criarmos um socket capaz utilizar os endereços com IP e Porta.
Além disso, a garantia do recebimento de pacotes facilita a elaboração da biblioteca.

Explicar mais sobre o tcp

\subsection{Nodo}
Cada nodo contem dois sockets, um para recebimento de mensagens e outro para envios.
Contem o enderecos de outros nodos e seu id.
...
1..1
Explicar a ordem causal

\subsection{Ordem Total}
1..n
Explicar a ordem total
